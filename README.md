...
![Coordinate plane](https://github.com/n3iton/Web_2/blob/main/Area.jpg)

- Координата Х задаётся через чекбоксы, а координата Y - через текстовое поле, R - через radiobutton'ы
- Метод HTTP: POST
- Список результатов хранится в контексте приложения
